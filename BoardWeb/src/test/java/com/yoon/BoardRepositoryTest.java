...
public class BoardRepositoryTest {
	...
	/*
	 * @Test public void testInsert() { Member member1 = new Member();
	 * member1.setId("member"); member1.setPassword("member123");
	 ...
	 * board.setMember(member2); board.setTitle(member2.getName() + "가 등록된 게시글 " +
	 * i); board.setContent(member2.getName() + "가 등록된 게시글  " + i);
	 * boardRepo.save(board); } }
	 */
	
	/*
	 * @Test public void testGetBoard() { Board board =
	 * boardRepo.findById(6L).get();
	 * 
	 ...
	 * System.out.println("등록일\t : " + board.getCnt()); }
	 */
